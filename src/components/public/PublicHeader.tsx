...
export function PublicHeader() {
  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-50 border-b border-slate-200/80 bg-white/95 shadow-sm backdrop-blur-md">
      ...
      <div className="absolute left-0 right-0 top-full border-b border-slate-200/80 bg-[#f4f8ff] shadow-sm">
        <div className="mx-auto flex h-[52px] max-w-7xl items-center gap-5 px-4 sm:px-6 lg:px-8">
          <Link
            to="/register"
            className="hidden shrink-0 items-center gap-2 text-sm font-semibold text-[#102449] transition hover:text-[#1b5dd7] lg:flex"
          >
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#1b5dd7] text-xs font-bold text-white">!</span>
            Pendaftaran Siswa Baru
          </Link>

          <form onSubmit={handleQuickSearch} className="min-w-0 flex-1 lg:max-w-xl lg:mx-auto">
            <label className="sr-only" htmlFor="quickspeak-search">Cari di QuickSpeak</label>
            <div className="flex h-9 items-center overflow-hidden rounded-full border border-slate-200 bg-white shadow-sm ring-1 ring-white">
              <span className="flex h-full w-10 items-center justify-center text-slate-400" aria-hidden="true">
              ...
              <input
                ...
                placeholder="Cari program, kelas, atau informasi QuickSpeak"
                className="min-w-0 flex-1 bg-transparent px-1 text-sm text-slate-700 outline-none placeholder:text-slate-400"
              />
              <button type="submit" className="h-full bg-[#102449] px-4 text-xs font-bold text-white transition hover:bg-[#143562]">
                Cari
              </button>
            </div>
          </form>
          ...
          <div className="hidden items-center gap-2 lg:flex" aria-label="QuickSpeak social media">
            <span className="sr-only">Sosial media QuickSpeak</span>
            <span title="YouTube" className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-[#102449] ring-1 ring-slate-200">
            ...
            <span title="Instagram" className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-[#102449] ring-1 ring-slate-200">
            ...
            <span title="Facebook" className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-[#102449] ring-1 ring-slate-200">
            ...
            <span title="LinkedIn" className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-[#102449] ring-1 ring-slate-200">
        ...
        <div className="flex h-10 items-center justify-between gap-3 px-4 lg:hidden sm:px-6">
          <Link to="/register" className="text-xs font-bold text-[#102449]">Pendaftaran Siswa Baru</Link>
          <button type="button" title="Pilih bahasa" className="flex items-center gap-1 text-xs font-bold text-[#102449]">EN <span className="text-[9px]">▾</span></button>
        </div>
      </div>
