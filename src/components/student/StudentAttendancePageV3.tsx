    ...
    <div className="space-y-6 pb-2">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="flex flex-col gap-4 border-b border-slate-200 px-6 py-5 sm:px-7">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><p className="text-[10px] font-bold uppercase tracking-[0.15em] text-slate-500">Detailed History</p><h2 className="mt-1 text-xl font-extrabold tracking-[-0.02em] text-[#102449]">Attendance Records</h2><p className="mt-1 text-sm text-slate-500">Showing {period}.</p></div><button type="button" onClick={download} disabled={!attendance.length || attendanceLoading} className="inline-flex w-fit items-center justify-center gap-2 rounded-lg bg-[#102449] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#17325f] disabled:cursor-not-allowed disabled:opacity-50"><Icon name="download" />Download PDF</button></div>
