          ...
          <section role="dialog" aria-modal="true" aria-labelledby="assessment-detail-title" className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl sm:p-7">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">Completed {formatDate(viewingResult.completed_at)} · Teacher {viewingResult.teacher_name ?? '—'}</p>
              </div>
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-3">
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-4">
                ...
                <p className="mt-1 text-sm font-extrabold text-[#102449]">{viewingResult.teacher_name ?? '—'}</p>
                <p className="mt-1 text-xs text-slate-500">{viewingResult.teacher_code ?? '—'}</p>
              </div>
            </div>
