              ...
              <dl className="grid gap-x-8 sm:grid-cols-2">
                {[
                  ...
                  <div key={label} className="border-b border-slate-100 py-4 last:border-b-0">
                    ...
                    <dd className="mt-1.5 break-words text-sm font-bold text-slate-950">{value}</dd>
                  </div>
                ))}
              </dl>
