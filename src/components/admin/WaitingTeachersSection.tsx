...
export function WaitingTeachersSection({ enabled }: WaitingTeachersSectionProps) {
  ...
  const paginatedTeachers = useMemo(() => filtered.slice((currentPage - 1) * pageSize, currentPage * pageSize), [currentPage, filtered])
