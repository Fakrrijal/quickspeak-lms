      ...
      <div className="flex flex-col gap-3 border-b border-slate-200 pb-5 sm:flex-row sm:items-start sm:justify-between">
        ...
        {packageStatus && (
          <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-right">
            <p className="text-[10px] font-bold uppercase tracking-[0.13em] text-slate-500">Package Progress</p>
            <p className="mt-1 text-sm font-extrabold text-[#102449]">
              {packageStatus.current_package_session_count}/{packageStatus.session_limit} sessions
            </p>
            ...
            <p className="mt-1 text-[11px] font-medium text-slate-400">
              Level cumulative: {packageStatus.cumulative_level_session_count} sessions
            </p>
          </div>
        )}
      </div>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="flex flex-col items-start gap-2 sm:items-end">
                <div className="rounded-xl border border-blue-100 bg-blue-50 px-4 py-3 sm:min-w-32 sm:text-right">
                  ...
                  <p className="mt-1 text-2xl font-extrabold text-[#102449]">{result.final_score}</p>
                  <p className="mt-1 text-xs font-bold text-blue-700">{result.result}</p>
                </div>
                <button
                  type="button"
      ...
      {detailsOpen && result && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 p-4" role="presentation">
          <section
            role="dialog"
            aria-modal="true"
            aria-labelledby="teacher-assessment-details-title"
            className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl sm:p-7"
          >
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-xl border border-emerald-100 bg-emerald-50 p-4">
                <p className="text-[10px] font-bold uppercase tracking-[0.11em] text-emerald-700">Result</p>
