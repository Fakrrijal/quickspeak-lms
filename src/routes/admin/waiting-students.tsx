...
function WaitingStudentsPage() {
  ...
  const paginatedStudents = useMemo(() => filtered.slice((currentPage - 1) * pageSize, currentPage * pageSize), [currentPage, filtered])
