  ...
  return (
    <section>
      ...
      <div className="mt-8 overflow-hidden rounded-xl border bg-white shadow-sm">
        <table className="w-full table-fixed divide-y divide-slate-200 text-left text-sm leading-tight">
          <colgroup>
            <col style={{ width: '24%' }} />
            <col style={{ width: '16%' }} />
            <col style={{ width: '11%' }} />
          ...
          <thead className="bg-slate-50 text-slate-700">
            <tr>
              ...
              <th className="px-3 py-2.5 font-semibold">Proof</th>
          ...
          <tbody className="divide-y divide-slate-200">
            {isLoading && (
              <tr>
                <td colSpan={7} className="px-3 py-5 text-slate-600">
            ...
            {!isLoading && paginatedPayments.map((payment) => {
              ...
              return (
                <tr key={payment.payment_id} className="align-top">
                  ...
                  <td className="break-all px-3 py-2.5 text-slate-700">{payment.invoice_number}</td>
                  <td className="break-words px-3 py-2.5 text-slate-700">{payment.package_type}</td>
                  <td className="px-3 py-2.5 text-slate-700">{formatAmount(payment.amount)}</td>
                  ...
                  <td className="break-words px-3 py-2.5">
                    ...
                    <p className="mt-1 break-words text-xs text-slate-500">{payment.proof_original_filename ?? 'Uploaded proof'}</p>
                  </td>
                  <td className="px-3 py-2.5">
                    ...
                    {isRejecting && (
                      <div className="mt-2 w-full min-w-0 space-y-2 rounded-lg border border-red-200 bg-red-50 p-2.5">
                        ...
                        <div className="flex flex-wrap gap-2">
                          <button
                            ...
                            className="rounded bg-red-700 px-2.5 py-1.5 text-xs font-medium text-white disabled:opacity-50"
                          >
                            Confirm rejection
                          </button>
                          <button
