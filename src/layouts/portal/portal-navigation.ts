  ...
  student: [
    {
      ...
      items: [
        ...
        { label: 'Books', to: '/student/learning?view=books', activePrefixes: ['/student/ebooks/'] },
        { label: 'Assessment', to: '/student/learning?view=assessment' },
        { label: 'History', to: '/student/learning?view=history' },
