-- S2.10 Payment Initialization RPC
-- Creates the single invoice and payment for a student's payment-pending enrollment.
...
BEGIN
    ...
    -- This lock serializes initialization calls for the same enrollment.
    SELECT *
    INTO v_enrollment
