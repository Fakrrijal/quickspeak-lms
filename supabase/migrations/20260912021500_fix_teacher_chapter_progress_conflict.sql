-- Final fix for Teacher Learning Progress chapter save.
-- Use the primary-key constraint name in ON CONFLICT so PL/pgSQL
-- output variables cannot be mistaken for table columns.
...
begin
  ...
  on conflict on constraint student_chapter_progress_pkey
  do update set
