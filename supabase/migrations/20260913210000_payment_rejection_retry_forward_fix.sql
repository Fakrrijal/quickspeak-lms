-- Forward fix for production environments that do not yet contain the
-- payment rejection retry objects from 20260907000300_payment_rejection_retry.
-- Keep rejected attempts immutable and create a new invoice/payment attempt.
