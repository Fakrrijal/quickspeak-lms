-- Attendance day boundary follows Indonesia/WIB calendar days (00:00-23:59).
-- Only the two active attendance v2 functions are changed.
-- Session consumption, one-attendance-per-day protection, and completion rules remain unchanged.
...
DECLARE
    ...
    v_submission jsonb;
    v_session_date date := (CURRENT_TIMESTAMP AT TIME ZONE 'Asia/Jakarta')::date;
