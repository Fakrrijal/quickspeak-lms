-- Targeted repair for the Phase 1 canonical detail RPC.  The output column
-- teacher_id is a PL/pgSQL variable, so live_amounts must qualify its CTE
-- column exactly as the prior canonical report did.
